          ...
          children: [
            SizedBox(
              ...
              child: IntroStepBuilder(
                order: 2,
                text: 'I can help you quickly implement the Step By Step guide in the Flutter project.',
            ...
            IntroStepBuilder(
              order: 3,
              text: 'My usage is also very simple, you can quickly learn and use it through example and api documentation.',
              builder: (context, key) => Placeholder(
                key: key,
                fallbackHeight: 100,
              ),
