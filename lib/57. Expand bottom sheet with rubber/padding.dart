...
class _AnimationPaddingPageState extends State<AnimationPaddingPage> with SingleTickerProviderStateMixin {
  late RubberAnimationController _controller;

  static final contain = AnimationPadding.contain();
  static final fivePercent = AnimationPadding.fromPercentages(bottom: 0.05, top: 0.05);
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text("In this example we see the behavior of a few AnimationPadding options."
          ...
          option(contain, "AnimationPadding.contain():\nbounce to edge of containing widget."),
          option(fivePercent,
