          ...
          Row(
            ...
            children: [
                  ...
                  child: Opacity(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(color: Colors.grey[500], fontSize: 12.5, fontWeight: FontWeight.w400),
                      ),
                    ),
                  ),
                )
              ...
              InkWell(
                ...
                child: Icon(Icons.cancel_outlined, color: Colors.black.withOpacity(.6), size: 18),
              )
            ],
          ),
          const SizedBox(
